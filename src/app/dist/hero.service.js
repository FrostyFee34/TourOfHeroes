...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.getHeroes = function () {
        var _this = this;
        return this.http.get(this.heroesUrl).pipe(operators_1.tap(function (_) { return _this.log('fetched data'); }), operators_1.catchError(this.handleError('getHeroes', [])));
    };
    ...
    HeroService.prototype.searchHeroes = function (term) {
        ...
        return this.http.get(this.heroesUrl + "/?name=" + term).pipe(operators_1.tap(function (x) {
            return x.length
                ? _this.log("found heroes matching \"" + term + "\"")
                : _this.log("no heroes matching \"" + term + "\"");
        }), operators_1.catchError(this.handleError('searchHeroes', [])));
    };
